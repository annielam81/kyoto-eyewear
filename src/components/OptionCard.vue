...
.oc.on{border-color:$sakura;background:#FFF0F5}
.oc.dim{opacity:.45}
.oc.big{border-width:4rpx;border-color:$sakura;background:#FFF0F5;box-shadow:0 20rpx 44rpx -28rpx rgba(255,79,139,.5)}
...
.lab{color:$sakura;font-weight:$fw-semi;font-size:$fs-xs}
