...
.hdr{display:flex;align-items:center;justify-content:space-between;padding:calc(#{$sp-2} + env(safe-area-inset-top)) $sp-3 18rpx;position:sticky;top:0;z-index:$z-nav;background:$paper;border-bottom:1rpx solid $line}
